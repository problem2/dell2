...
function modify_logo() {
    ...
    $logo_style .= 'h1 a {background-image: url(' . get_template_directory_uri() . '/assets/images/logo.png) !important;}';
    $logo_style .= '</style>';
    echo $logo_style;
}
...
function modify_reg() {
    $logo_style = '<style type="text/css">';
    $logo_style .= '.login #nav a:first-child {display:none !important;}';
    $logo_style .= '</style>';
    echo $logo_style;
}
add_action('login_footer', 'modify_reg'); 


function modify_width() {
    $logo_style = '<style type="text/css">';
    $logo_style .= '#login {width: 400px !important;}';
    $logo_style .= '</style>';
    echo $logo_style;
}
add_action('login_head', 'modify_width'); 
